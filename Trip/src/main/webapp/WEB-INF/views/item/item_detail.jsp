	...
	<div class="row justify-content-center">
		...
		<div class="row g-2 justify-content-center">
			...
			<div class="col-4" style="padding-left: 20px;">
				...
				<div>
					<span style="font-size: 12.5px; margin-left: 1px; padding: 5px; cursor: pointer; background-color: #666666; color: white; border-radius: 5px;" id="mapModal" data-bs-toggle="modal" data-bs-target="#exampleModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-geo-alt" viewBox="0 0 16 16">
